...
secret = int(input('Enter the secret number Bob chose as the index (must be less that the prime modulus):'))

bob = (pow(base, secret)) % mod
...
if que == 'y':
    ...
    secretkey =(pow(alice, secret)) % mod
